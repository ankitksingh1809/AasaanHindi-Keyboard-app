...
public class SoftKeyboard extends InputMethodService
    ...
    private Keyboard mAltKeyboard;
    private Keyboard mAltKeyboard1;
    ...
    @Override public void onCreate() {
        ...
        Log.d("SpellChecker", String.valueOf(mScs.getSpellChecker()));
    }
    ...
    @Override public void onInitializeInterface() {
        ...
        mQwertyKeyboard = new Keyboard(this, R.xml.keyboard);
        mAltKeyboard = new Keyboard(this, R.xml.keyboard1);
        mAltKeyboard1 = new Keyboard(this, R.xml.keyboard2);
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        if (isWordSeparator(primaryCode)) {
            ...
            if (current == mSymbolsKeyboard) {
                mSymbolsShiftedKeyboard.resize(mInputView.getWidth(),mInputView.getHeight());
                mSymbolsShiftedKeyboard.setImeOptions(getResources(),mEditorInfo.imeOptions);
                setKeyboard(mSymbolsShiftedKeyboard);
                mSymbolsShiftedKeyboard.setShifted(false);
            } else if(current == mSymbolsShiftedKeyboard){
                mSymbolsKeyboard.resize(mInputView.getWidth(),mInputView.getHeight());
                mSymbolsKeyboard.setImeOptions(getResources(),mEditorInfo.imeOptions);
                setKeyboard(mSymbolsKeyboard);
                mSymbolsKeyboard.setShifted(false);
            } else if(current == mQwertyKeyboard) {
                mAltKeyboard.resize(mInputView.getWidth(),mInputView.getHeight());
                mAltKeyboard.setImeOptions(getResources(),mEditorInfo.imeOptions);
                setKeyboard(mAltKeyboard);
                mAltKeyboard.setShifted(false);
            } else if(current == mAltKeyboard) {
                mAltKeyboard1.resize(mInputView.getWidth(),mInputView.getHeight());
                mAltKeyboard1.setImeOptions(getResources(),mEditorInfo.imeOptions);
                setKeyboard(mAltKeyboard1);
                mAltKeyboard1.setShifted(false);
            }else if(current == mAltKeyboard1) {
                mQwertyKeyboard.resize(mInputView.getWidth(),mInputView.getHeight());
                mQwertyKeyboard.setImeOptions(getResources(),mEditorInfo.imeOptions);
                setKeyboard(mQwertyKeyboard);
                mQwertyKeyboard.setShifted(false);
            }
        } else if(primaryCode == Keyboard.KEYCODE_MODE_CHANGE1
                && mInputView != null){
            Keyboard current = mInputView.getKeyboard();
